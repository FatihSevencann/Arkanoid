...
static cocos2d::Size arkanoidResolutionSize=cocos2d::Size(450,750);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("ARKANOID", cocos2d::Rect(0, 0, arkanoidResolutionSize.width, arkanoidResolutionSize.height));
#else
